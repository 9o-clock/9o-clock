...
CREATE INDEX IF NOT EXISTS IDX_QUIZ_SUBMIT_QUIZ_ID_MEMBER_ID on QUIZ_SUBMIT (quiz_id,member_id);
CREATE INDEX IF NOT EXISTS IDX_QUIZ_SUBMIT_MEMBER_ID on QUIZ_SUBMIT (member_id);
