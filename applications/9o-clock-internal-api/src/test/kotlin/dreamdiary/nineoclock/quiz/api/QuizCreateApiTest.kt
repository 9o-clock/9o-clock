...
internal class QuizCreateApiTest {
    ...
    fun setUp() {
        ...
        lenient().`when`(mockQuizCreateUseCase.createQuiz(any())).thenReturn(QuizCreateResult("TTTT"))
    }
    ...
    fun createQuiz_return_value() {
        val givenResult = QuizCreateResult("givenResult")
        ...
        mockMvc.perform(post("/quizzes")
            ...
            .content(
                ...
                """.trimIndent()))
            .andExpect(jsonPath("$.id", equalTo(givenResult.quizPublicId)))
    }
}
